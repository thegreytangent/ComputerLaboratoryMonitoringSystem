                        ...
                        <ul class="list-unstyled">
                            ...
                            <div class="page-content--bgf7">
                                            ...
                                            <table class="table table-borderless table-data3">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">2018-09-02</td>
                                                        <td class="text-center">ComLab3</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">2018-09-02</td>
                                    <td class="text-center">ComLab2</td>
                                    <td class="text-center">Joshua</td>
                                    <td class="text-center">Fix/Check/Clean</td>
                                    <td class="text-center">Hard Drive</td>
                                    <td class="text-center">Done</td>
                                </tr>
                                <tr>
                                    <td class="text-center">4</td>
                                    <td class="text-center">2018-09-02</td>
                                    <td class="text-center">ComLab6</td>
                                    <td class="text-center">Noelyn</td>
                                    <td class="text-center">Replacement</td>
